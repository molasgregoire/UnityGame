...
public class oJauge : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        jauge.transform.localScale = new Vector3(height, 0.7f, 0);
        jauge.transform.position = new Vector3(4.96f, 3.62f, 1);
        ...
        mask.transform.localScale = new Vector3(height, 0.7f, 0);
        mask.transform.position = new Vector3(4.96f, 3.62f, 1);
        ...
        jaugeTps.transform.localScale = new Vector3(0, 0.2f, 0);
        jaugeTps.transform.position = new Vector3(-2.95f, 4.25f, 1f);
    ...
    void gestionTemps()
    {
        ...
        if (oTimer.tps - startTime > 0 && oTimer.tps - endTime < 0)
        {
            ...
            jaugeTps.transform.localScale = new Vector3(scaling, 0.2f, 0);
        }
        /*
